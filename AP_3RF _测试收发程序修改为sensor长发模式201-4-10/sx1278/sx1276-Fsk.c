...
void SX1276FskInit( void )
{
    ...
    SX1276ReadBuffer( REG_OPMODE, (uint8_t *)((int)SX1276 + 1), 0x70 - 1 );
    ...
    SX1276->RegPayloadLength = FskSettings.PayloadLength;
		SX1276->RegPacketConfig2 = 0;
    // we can now update the registers with our configuration
    SX1276WriteBuffer( REG_OPMODE, (uint8_t *)((int)SX1276 + 1), 0x70 - 1 );

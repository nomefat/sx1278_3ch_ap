...
tLoRaSettings LoRaSettings =
{
    ...
    100,              // TxPacketTimeout
    100,              // RxPacketTimeout
    11,              // PayloadLength (used for implicit header mode)
};
...
void SX1276LoRaInit( void )
{
    ...
    SX1276ReadBuffer( REG_LR_OPMODE, (uint8_t *)((int)SX1276LR + 1), 0x70 - 1 );
    
    SX1276LR->RegLna = RFLR_LNA_GAIN_G1;
	  SX1276LR->RegOcp = 0x0c;

#if(RF_LORA_CONTINUE_SEND == 1)
		SX1276LR->RegModemConfig2 |= 0x08;   //打开即进入持续发送模式
#endif	
	
    SX1276WriteBuffer( REG_LR_OPMODE, (uint8_t *)((int)SX1276LR + 1), 0x70 - 1 );
...
*/
void SX1276LoRaSendPkt(void *pdata)
{
